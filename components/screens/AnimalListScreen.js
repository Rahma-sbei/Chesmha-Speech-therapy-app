...
const animalData = [
    ...
    { id: 'giraffe', name: 'Giraffe', image: require('../assets/giraffe.jpg') },
    { id: 'turtle', name: 'Turtle', image: require('../assets/turtle.jpg') },
    { id: 'gorilla', name: 'Gorilla', image: require('../assets/gorilla.jpg') },
    { id: 'frog', name: 'Frog', image: require('../assets/frog.jpg') },
    { id: 'squirrel', name: 'Squirrel', image: require('../assets/squirrel.jpg') },
            ...
            <View style={styles.container}>
                ...
                <ScrollView contentContainerStyle={styles.animalListContainer}>
                    {filteredAnimals.map((animal) => (
                        <TouchableOpacity key={animal.id} style={styles.animalItem} onPress={() => handleAnimalPress(animal.id)}>
