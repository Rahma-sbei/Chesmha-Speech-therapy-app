...
const foodData = [
    { id: 'couscous', name: 'Couscous', image: require('../assets/couscous.jpg') },
    { id: 'brik', name: 'Brik', image: require('../assets/Brik.jpg') },
    { id: 'lablabi', name: 'Lablabi', image: require('../assets/lablebi.jpg') },
    { id: 'mouchouia', name: 'Mouchouia salad', image: require('../assets/Machouia salad.jpg') },
    { id: 'ojja', name: 'Ojja', image: require('../assets/Ojja.jpg') },
    { id: 'kafteji', name: 'Kafteji', image: require('../assets/kafteji.jpg') },
    { id: 'mloukhia', name: 'Mloukhia', image: require('../assets/Mloukhia.jpg') },
    { id: 'chorba', name: 'Chorba', image: require('../assets/chorba.jpg') },
    { id: 'mechoui', name: 'Mechoui', image: require('../assets/Mechoui.jpg') },
    { id: 'mosli', name: 'Mosli', image: require('../assets/Mosli.jpg') },
    { id: 'makarouna', name: 'Makarouna', image: require('../assets/Makarouna.jpg') },
              ...
              <View style={{ width: 24 }} />
                ...
                <ScrollView contentContainerStyle={styles.foodListContainer}>
                    {filteredFoods.map((food) => (
                        <TouchableOpacity key={food.id} style={styles.foodItem} onPress={() => navigation.navigate('FoodDetail', { foodId: food.id })}>
